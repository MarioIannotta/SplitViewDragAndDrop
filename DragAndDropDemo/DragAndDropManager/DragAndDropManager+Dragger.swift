//
//  DragAndDropManager+Dragger.swift
//  DragAndDropDemo
//
...
extension DragAndDropManager {
    ...
    internal class Dragger: NSObject {
        ...
        internal init(dragAndDropManager: DragAndDropManager) {
        ...
        private func transformXCoordinate(_ value: CGFloat, updateTriggeredToRight: Bool) -> CGFloat {
        ...
        @objc private func handleGestureRecognizer(_ gestureRecognizer: UIPanGestureRecognizer) {
            ...
            case .ended:
                ...
                if !updateTriggered {
                    DragAndDropManager.completeDragging(isFallBack: true, draggingView: self.viewToDragSnapshotImageView, targetCenterPoint: self.initialDragPoint, completion: nil)
                }
            ...
            default:
                ...
                if updateTriggered || shouldTriggerUpdate {
                    ...
                    let frame = CGRect(
                        x: transformXCoordinate(viewToDragSnapshotImageView.frame.origin.x, updateTriggeredToRight: updateTriggeredToRight),
                    ...
                    initialDragPoint.x = transformXCoordinate(initialDragPoint.x, updateTriggeredToRight: updateTriggeredToRight)
        ...
        internal override func observeValue(
            ...
            case StoreKeys.draggingValidation:
                    ...
                    let initialDragPoint = draggingValidation[StoreKeys.DraggingValidation.initialDragPoint] as? CGPoint, initialDragPoint.x > 0, initialDragPoint.x < UIWindow.width
                {
                    ...
                    DragAndDropManager.completeDragging(isFallBack: true, draggingView: self.viewToDragSnapshotImageView, targetCenterPoint: initialDragPoint, completion: nil)
