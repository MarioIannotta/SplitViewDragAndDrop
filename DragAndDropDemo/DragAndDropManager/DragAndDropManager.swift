...
class DragAndDropManager: NSObject {
    ...
    private static var shared: DragAndDropManager!
        ...
        case StoreKeys.gestureRecognizer:
                ...
                
            {
                ...
                case .ended:
                    ...
                    initialPoint.x = transformXCoordinate(initialPoint.x, updateTriggeredToRight: !draggingGestureRecognizerIsTriggerToRight)
                    ...
                    if draggingViewFrame?.origin.x != 0 && draggingViewFrame?.origin.y != 0 {
                        ...
                        if draggingValidationResult {
                            ...
                            DragAndDropManager.completeDragging(
                                isFallBack: false,
    ...
    open static func configure(groupIdentifier: String) {
        ...
        shared = DragAndDropManager(groupIdentifier: groupIdentifier)
